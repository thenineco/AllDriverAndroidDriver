...
public class FillUpMoneyFragment extends AppBaseFragment implements FillUpMoneyView {
    public static final String TAG = "FillUpMoneyFragment";
    @InjectPresenter
    ...
    public static FillUpMoneyFragment newInstance() {
        FillUpMoneyFragment fragment = new FillUpMoneyFragment();
